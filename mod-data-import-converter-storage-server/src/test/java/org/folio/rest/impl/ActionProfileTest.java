...
public class ActionProfileTest extends AbstractRestVerticleTest {
  ...
  private static final String DEFAULT_CREATE_DERIVE_AUTHORITY_ACTION_PROFILE_ID = "7915c72e-c6af-4962-969d-403c7238b051";
  ...
  public void shouldReturnBadRequestOnPutWithDefaultDeriveMarcAuthorities() {
    ...
    RestAssured.given()
      ...
      .body(actionProfile_1)
      .when()
      .put(ACTION_PROFILES_PATH + "/" + DEFAULT_CREATE_DERIVE_AUTHORITY_ACTION_PROFILE_ID)
      .then()
      .statusCode(HttpStatus.SC_BAD_REQUEST);
  }
  ...
  public void shouldReturnBadRequestOnDeleteDefaultDeriveMarcAuthorities() {
    ...
    RestAssured.given()
      .spec(spec)
      .when()
      .delete(ACTION_PROFILES_PATH + "/" + DEFAULT_CREATE_DERIVE_AUTHORITY_ACTION_PROFILE_ID)
      .then()
      .statusCode(HttpStatus.SC_BAD_REQUEST);
  }
