...
public class ModTenantAPI extends TenantAPI {
  ...
  private static final String DEFAULT_INSTANCE_AND_SRS_MARC_BIB_CREATE_JOB_PROFILE = "templates/db_scripts/defaultData/default_instance_and_srs_marc_bib_create_job_profile.sql";
  ...
  Future<Integer> loadData(TenantAttributes attributes, String tenantId, Map<String, String> headers, Context context) {
    return super.loadData(attributes, tenantId, headers, context)
      .compose(num -> setupDefaultData(DEFAULT_JOB_PROFILE_SQL, headers, context)
        ...
        .compose(m -> setupDefaultData(DEFAULT_INSTANCE_AND_SRS_MARC_BIB_CREATE_JOB_PROFILE, headers, context))
